    ...
    if (isEmpty) {
        return (
            <div className="min-h-screen bg-[#f1f1f2] flex items-center justify-center px-4">
                <div className="bg-white rounded-3xl shadow-2xl p-12 text-center max-w-lg w-full transform transition-all hover:scale-[1.02]">
                    ...
                    <p className="text-gray-500 mb-8 text-lg">Looks like you hasn't added anything to your cart yet. Let's find something special for you!</p>
                    <Link
                        href="/"
                        className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-white px-8 py-4 rounded-2xl font-black text-lg hover:shadow-[0_10px_20px_rgba(139,92,246,0.3)] transition-all active:scale-95 w-full"
                    >
        ...
        <div className="min-h-screen bg-[#f1f1f2] py-8 md:py-12">
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex items-center justify-between mb-10">
                    ...
                    <button
                        onClick={() => clearCart()}
                        className="text-gray-400 hover:text-red-500 flex items-center gap-2 text-sm font-bold transition-colors group"
                    >
                        ...
                        <div className="bg-white rounded-[32px] shadow-2xl shadow-purple-500/10 border border-gray-100 p-8 sticky top-28 overflow-hidden">
                            ...
                            <div className="mt-8 space-y-4">
                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
                                    <div className="flex-1">
                                        <p className="text-sm font-bold text-gray-700">Have a coupon code?</p>
                                        <p className="text-xs text-gray-400 font-medium">Apply it at checkout for extra savings</p>
                                    </div>
                                </div>
                            </div>

                            <p className="text-center text-sm text-gray-400 font-medium mt-8 flex items-center justify-center gap-2">
